...
final class PageController
{
    ...
    {
        $page = new Page();
        $page->setTitle($request->request->getString('title', 'New page'));
    ...
    public function builder(int $id): Response
    {
        ...
        return new Response($this->twig->render('page/builder.html.twig', ['page' => $page]));
    }
    ...
    public function show(int $id): Response
    {
        ...
        return new Response($this->twig->render('page/show.html.twig', ['page' => $page]));
    }
}
