...
final class LoadDemoPagesCommand extends Command
{
    ...
    private function buildLanding(): Page
    {
        ...
        // Bocklip brand presentation (CEO Diane Pollet) — embeddable clip from the
        // client's own YouTube channel, used for their in-person demo.
        $this->block($col, 'embed', ['url' => 'https://www.youtube.com/watch?v=LCaRmZK6i2A', 'title' => 'Découvrez Bocklip'], $b++);
